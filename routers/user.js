...
module.exports = () => {
	...
	router.post('/signup', Celebrate.user.signup, UserMiddleware.checkRegister, UserController.postSignUp);
	router.get('/search', Celebrate.user.search, UserMiddleware.checkRole, UserController.searchUser);
	router
		.route('/')
